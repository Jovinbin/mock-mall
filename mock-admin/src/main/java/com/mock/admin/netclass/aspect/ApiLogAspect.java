package com.mock.admin.netclass.aspect;

import cn.hutool.core.thread.threadlocal.NamedThreadLocal;
import cn.hutool.core.util.IdUtil;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.mock.common.util.IpUtil;
import com.mock.common.util.TimeStampUtil;
...
public class ApiLogAspect {
    ...
    @Pointcut("execution(* com.mock.admin.netclass.controller.*..*(..))")
    public void apiLog() {
    }
