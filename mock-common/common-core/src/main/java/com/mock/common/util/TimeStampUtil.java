...
public class TimeStampUtil {
    ...
    public static String timeStamp2DateTimeStr(Long timeStamp) {
        ...
        return new SimpleDateFormat(DATETIME_PATTERN).format(new Date(Long.parseLong(timeStamp + "000")));
    }
    ...
    public static String timeStamp2DateStr(Long timeStamp) {
        ...
        return new SimpleDateFormat(DATE_PATTERN).format(new Date(Long.parseLong(timeStamp + "000")));
    }
    ...
    public static String timeStamp2YearMonth(Long timeStamp) {
        ...
        return new SimpleDateFormat(YEAR_MONTH_PATTERN).format(new Date(Long.parseLong(timeStamp + "000")));
    }
    ...
    public static Date timeStamp2Date(Long timeStamp) {
        if (timeStamp.toString().length() == TEN) {
            timeStamp = timeStamp * THOUSAND;
        }
    ...
    public static Long date2TimeStamp(String dateStr) throws ParseException {
        ...
        return new SimpleDateFormat(DATE_PATTERN).parse(dateStr).getTime() / THOUSAND;
    }
